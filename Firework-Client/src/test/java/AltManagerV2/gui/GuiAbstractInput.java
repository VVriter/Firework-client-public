...
public abstract class GuiAbstractInput extends GuiScreen {
    ...
    public void initGui() {
        ...
        usernameField = new GuiTextField(
                0, fontRenderer, width / 2 - 100, height / 2 - 45, 200, 20
        );
        usernameField.setFocused(true);
        usernameField.setMaxStringLength(64);
        passwordField = new GuiTextField(
                1, fontRenderer, width / 2 - 100, height / 2 - 15, 200, 20
        );
    ...
    public void drawScreen(int mouseX, int mouseY, float renderPartialTicks) {
        ...
        drawCenteredString(
                fontRenderer, actionMessage, width / 2, 7, -1
        );
        drawCenteredString(
                fontRenderer, "Username", width / 2 - 130, height / 2 - 39, 0xFFA0A0A0
        );
        drawCenteredString(
                fontRenderer, "Password", width / 2 - 130, height / 2 - 9, 0xFFA0A0A0
        );
    }
