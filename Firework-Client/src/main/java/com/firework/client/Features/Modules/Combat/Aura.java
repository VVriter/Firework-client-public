...
public class Aura extends Module {
    ...
    public Setting<Boolean> players = new Setting<>("Players", true, this).setVisibility(()-> targetsSubBool.getValue());
    public Setting<Boolean> animals = new Setting<>("Animals", true, this).setVisibility(()-> targetsSubBool.getValue());
    public Setting<Boolean> mobs = new Setting<>("Mobs", true, this).setVisibility(()-> targetsSubBool.getValue());
    public Setting<Boolean> boat = new Setting<>("Boat", true, this).setVisibility(()-> targetsSubBool.getValue());
    public Setting<Boolean> armourStand = new Setting<>("ArmourStand", true, this).setVisibility(()-> targetsSubBool.getValue());
    public Setting<Boolean> interactionsSubBool = new Setting<>("Interact", false, this).setMode(Setting.Mode.SUB);
    public Setting<AttackMode> attackMode = new Setting<>("Mode", AttackMode.CustomDelay, this).setVisibility(()-> interactionsSubBool.getValue());
    public Setting<Boolean> packet = new Setting<>("Packet", true, this).setVisibility(()-> interactionsSubBool.getValue() && (attackMode.getValue(AttackMode.Old) || attackMode.getValue(AttackMode.CustomDelay)));
    public Setting<Boolean> swing = new Setting<>("Swing", true, this).setVisibility(()-> interactionsSubBool.getValue() && (attackMode.getValue(AttackMode.Old) || attackMode.getValue(AttackMode.CustomDelay)));
    public Setting<Double> attackDelay = new Setting<>("CustomDelay", (double)4, this, 1, 1000).setVisibility(()-> interactionsSubBool.getValue() && attackMode.getValue(AttackMode.CustomDelay));
    public Setting<Boolean> randomAttackDelay = new Setting<>("Random", true, this).setVisibility(()-> interactionsSubBool.getValue() && attackMode.getValue(AttackMode.CustomDelay));
    public Setting<Integer> minRandom = new Setting<>("MinRandom", 400, this, 1, 1000).setVisibility(()-> interactionsSubBool.getValue() && attackMode.getValue(AttackMode.CustomDelay) && randomAttackDelay.getValue());
    public Setting<Integer> maxRandom = new Setting<>("MaxRandom", 600, this, 1, 1000).setVisibility(()-> interactionsSubBool.getValue() && attackMode.getValue(AttackMode.CustomDelay) && randomAttackDelay.getValue());

    public Setting<Boolean> rotationsSubBool = new Setting<>("Rotations", false, this).setMode(Setting.Mode.SUB);
    public Setting<Boolean> rotate = new Setting<>("Rotate", true, this).setVisibility(()-> rotationsSubBool.getValue());
    public Setting<Bones> bone = new Setting<>("Bone", Bones.Foot, this).setVisibility(()-> rotationsSubBool.getValue());
    public Setting<Double> randomBoneDelay = new Setting<>("RandomDelay", (double)500, this, 1, 1000).setVisibility(()-> rotationsSubBool.getValue() && bone.getValue(Bones.Random));

    public Setting<Boolean> switchSubBool = new Setting<>("Switch", false, this).setMode(Setting.Mode.SUB);
    public Setting<SwitchModes> switchMode = new Setting<>("SwitchMode", SwitchModes.Normal, this).setVisibility(()-> switchSubBool.getValue());
    public Setting<Double> switchDelay = new Setting<>("SwitchDelay", (double)4, this, 0, 1000).setVisibility(()-> switchSubBool.getValue());
    public Setting<Boolean> pauseSubBool = new Setting<>("Pause", false, this).setMode(Setting.Mode.SUB);
    public Setting<Boolean> eat = new Setting<>("Eat", true, this).setVisibility(()-> pauseSubBool.getValue());
    public Setting<Boolean> mine = new Setting<>("Mine", true, this).setVisibility(()-> pauseSubBool.getValue());
    public Setting<Boolean> renderSubBool = new Setting<>("Render", false, this).setMode(Setting.Mode.SUB);
    public Setting<RenderMode> renderMode = new Setting<>("RenderMode", RenderMode.Circle, this).setVisibility(()-> renderSubBool.getValue());
    public Setting<Double> moveCircleDelay = new Setting<>("MoveCircleDelay", (double)3, this, 1, 100).setVisibility(()-> renderSubBool.getValue() && renderMode.getValue(RenderMode.Circle));
    public Setting<HSLColor> circleColor = new Setting<>("CircleColor", new HSLColor(1, 54, 43), this).setVisibility(()-> renderSubBool.getValue() && renderMode.getValue(RenderMode.Circle));
    public Setting<Double> radius = new Setting<>("Radius", (double)0.5, this, 0, 3).setVisibility(()-> renderSubBool.getValue() && renderMode.getValue(RenderMode.Circle));
    public Setting<HSLColor> boxColor = new Setting<>("BoxColor", new HSLColor(1, 54, 43), this).setVisibility(()-> renderSubBool.getValue() && renderMode.getValue(RenderMode.Box));

    public Setting<Integer> lineWidth = new Setting<>("LineWidth", 3, this, 0, 10).setVisibility(()-> renderSubBool.getValue());
