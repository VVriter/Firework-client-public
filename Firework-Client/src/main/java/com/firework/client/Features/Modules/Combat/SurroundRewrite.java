...
public class SurroundRewrite extends Module {
    ...
    private Setting<MotionUtil.centerModes> centerMode = new Setting<>("CMode", MotionUtil.centerModes.Motion, this, MotionUtil.centerModes.values()).setVisibility(shouldCenter, true);
