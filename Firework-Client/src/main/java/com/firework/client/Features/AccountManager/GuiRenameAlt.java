...
public class GuiRenameAlt
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(this.fontRenderer, "Edit Alt", width / 2, 10, -1);
        this.drawCenteredString(this.fontRenderer, this.status, width / 2, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            this.drawString(this.mc.fontRenderer, "New name", width / 2 - 96, 66, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            this.drawString(this.mc.fontRenderer, "New password", width / 2 - 96, 106, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.nameField = new GuiTextField(2, this.mc.fontRenderer, width / 2 - 100, 60, 200, 20);
