...
public class MultiHand extends Module {
    ...
    public Setting<hands> totemHandMode = new Setting<>("Totem", hands.MainHand, this, hands.values()).setVisibility(v-> multiHandMode.getValue(modes.Totem));
    public Setting<hands> crystalHandMode = new Setting<>("Crystal", hands.MainHand, this, hands.values()).setVisibility(v-> multiHandMode.getValue(modes.Crystal));
