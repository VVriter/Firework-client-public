...
public class Jesus extends Module {
    ...
    public Setting<Double> speedDouble = new Setting<>("Horizontal", (double)2.1, this, 1, 5).setVisibility(()-> speedBool.getValue(true));

    public Setting<Double> UpSped = new Setting<>("UpSpeed", (double)0.3, this, 0.1, 1).setVisibility(()-> mode.getValue(modes.Fly));
    public Setting<Double> DpwnSped = new Setting<>("DownSpeed", (double)0.3, this, 0.1, 1).setVisibility(()-> mode.getValue(modes.Fly));
    public Setting<Boolean> antikick = new Setting<>("AntiKick", true, this).setVisibility(()-> mode.getValue(modes.Fly));
