...
public class GuiAddAlt
    ...
    public void drawScreen(int i2, int j2, float f2) {
        ...
        this.drawCenteredString(this.fontRenderer, "Add Alt", width / 2, 20, -1);
        ...
        this.drawCenteredString(this.fontRenderer, this.status, width / 2, 30, -1);
    ...
    public void initGui() {
        ...
        this.username = new GuiTextField(1, this.mc.fontRenderer, width / 2 - 100, 60, 200, 20);
    ...
    private class AddAltThread
        ...
        public AddAltThread(String username, String password) {
            ...
            GuiAddAlt.access$0(GuiAddAlt.this, (Object)((Object)ChatFormatting.GRAY) + "Idle...");
        }
        ...
        private final void checkAndAddAlt(String username, String password) throws IOException {
            ...
            try {
                ...
                GuiAddAlt.access$0(GuiAddAlt.this, (Object)((Object) ChatFormatting.RED) + "Alt failed!");
                e.printStackTrace();
            }
        }
        ...
        public void run() {
            if (this.password.equals("")) {
                ...
                GuiAddAlt.access$0(GuiAddAlt.this, (Object)((Object)ChatFormatting.GREEN) + "Alt added. (" + this.username + " - offline name)");
                return;
            }
            GuiAddAlt.access$0(GuiAddAlt.this, (Object)((Object)ChatFormatting.YELLOW) + "Trying alt...");
            try {
