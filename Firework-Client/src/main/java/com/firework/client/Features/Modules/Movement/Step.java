...
public class Step extends Module {
    public Setting<modes> moderio = new Setting<>("Mode", modes.MegaBypass, this);
    public enum modes{
       MegaBypass, Vanilla
    }
    ...
    public Setting<mode> moveMode = new Setting<>("SubMode", mode.Motion, this).setVisibility(v-> moderio.getValue(modes.MegaBypass));
