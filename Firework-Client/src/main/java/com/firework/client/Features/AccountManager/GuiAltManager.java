...
public class GuiAltManager
    ...
    private String status = (Object)((Object) ChatFormatting.GRAY) + "No alts selected";
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            case 0: {
                ...
                if (!this.loginThread.getStatus().equals((Object)((Object)ChatFormatting.YELLOW) + "Attempting to log in") && !this.loginThread.getStatus().equals((Object)((Object)ChatFormatting.RED) + "Do not hit back!" + (Object)((Object)ChatFormatting.YELLOW) + " Logging in...")) {
                    this.mc.displayGuiScreen(null);
                    break;
                }
                this.loginThread.setStatus((Object)((Object)ChatFormatting.RED) + "Failed to login! Please try again!" + (Object)((Object)ChatFormatting.YELLOW) + " Logging in...");
                break;
            }
            case 1: {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(this.fontRenderer, this.loginThread == null ? this.status : this.loginThread.getStatus(), width / 2, 20, -1);
       // GuiUtils.drawContinuousTexturedBox(50.0f, 33.0f, width - 50, height - 50, 1.0f, -16777216, Integer.MIN_VALUE);
        GL11.glPushMatrix();
        this.prepareScissorBox(0.0f, 33.0f, width, height - 50);
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 =Firework.altManager;
        for (Alt alt2 : AltManager.registry) {
            ...
            this.drawCenteredString(this.fontRenderer, name, width / 2, y2 - this.offset, -1);
            this.drawCenteredString(this.fontRenderer, pass, width / 2, y2 - this.offset + 10, 5592405);
            y2 += 26;
        }
        GL11.glDisable(3089);
        GL11.glPopMatrix();
