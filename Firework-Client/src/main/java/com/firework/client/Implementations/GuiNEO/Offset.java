...
import com.firework.client.Implementations.GuiNEO.Components.Advanced.SettingIndicator;
...
public class Offset {
    ...
    public void register(Button... button) {
        ...
        SettingIndicator settingIndicator = new SettingIndicator(x-2, y, 2, offset);
