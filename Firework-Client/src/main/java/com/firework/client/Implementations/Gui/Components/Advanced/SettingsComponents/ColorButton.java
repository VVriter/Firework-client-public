...
public class ColorButton extends Button {
    ...
    public void drawBase(){
        int outlineWidth = 3;
        RenderUtils2D.drawRectangle(new Rectangle(x, y, width, standartHeight), fillColorB);
        RenderUtils2D.drawRectangleOutline(new Rectangle(x, y, width,
                standartHeight), outlineWidth, outlineColorA);
    ...
    public void draw() {
        ...
        if(setting.opened) {
            ...
            RenderUtils2D.drawColorPickerBase(new Rectangle(x+5, y+11+5, width-10, height-10), Color.GREEN, Color.BLUE, Color.PINK, Color.YELLOW,Color.WHITE);
        }else{
            drawBase();
        }
    }
