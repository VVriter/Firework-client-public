...
public class UtilShader {
        ...
        public UtilShader(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        public UtilShader(String fragmentShaderLoc) {
            this(fragmentShaderLoc, "firework/shaders/vertex.vsh");
        }
